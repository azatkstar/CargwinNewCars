...
const CoverageMap = () => {
  const coverageAreas = [
    { name: 'LA County', status: 'full', color: '#dc2626' },
    { name: 'Orange County', status: 'full', color: '#dc2626' },
    { name: 'South Bay', status: 'full', color: '#dc2626' },
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-lg text-gray-600 max-w-2xl mx-auto">
            Мы работаем с проверенными дилерами по всему Лос-Анджелесу и прилегающим районам
          </p>
        </div>
          ...
          <div className="order-2 lg:order-1">
            <div className="bg-gray-50 rounded-2xl p-8 border border-gray-200">
              ...
              >
                ...
                {/* Major Cities */}
                <circle cx="120" cy="150" r="3" fill="white" stroke="#dc2626" strokeWidth="2" />
                <text x="120" y="140" textAnchor="middle" className="text-xs font-medium fill-gray-900">
                  LA
                </text>

                <circle cx="230" cy="220" r="3" fill="white" stroke="#dc2626" strokeWidth="2" />
                <text x="230" y="210" textAnchor="middle" className="text-xs font-medium fill-gray-900">
                  Anaheim
                </text>

                <circle cx="140" cy="250" r="3" fill="white" stroke="#dc2626" strokeWidth="2" />
            ...
            <div className="space-y-6">
                ...
                <div key={area.name} className="flex items-center gap-4 p-4 bg-gray-50 rounded-lg border border-gray-200">
                  ...
                  <div className="flex-1">
                    ...
                    <div className="text-sm text-gray-600 mt-1">
                      {area.status === 'full' && 'Все дилеры, быстрая доставка'}
                      {area.status === 'partial' && 'Основные дилеры, 1-2 дня'}
                      {area.status === 'negotiable' && 'По запросу, до 3-5 дней'}
                    </div>
                  </div>
                </div>
              ))}
              ...
              <div className="bg-blue-50 border border-blue-200 rounded-lg p-4 mt-6">
                <p className="text-sm text-blue-800">
                  <strong>Расширяемся!</strong> Если вашего района нет в списке, свяжитесь с нами — возможно, мы сможем организовать доставку по специальной договорённости.
                </p>
              </div>
            </div>
          </div>
