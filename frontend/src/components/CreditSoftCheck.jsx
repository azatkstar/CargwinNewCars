          ...
          <Card className="border-2 border-green-200 shadow-lg">
            <CardContent className="p-8 text-center">
              ...
              <h3 className="text-2xl font-bold text-gray-900 mb-4">
                {t('forms.credit_check.check_complete')}
              </h3>
              
              <p className="text-gray-600 mb-6">
                {t('forms.credit_check.check_results_message')}
              </p>
              
              <div className="bg-green-50 border border-green-200 rounded-lg p-4">
                <p className="text-sm text-green-800">
                  <strong>{t('forms.credit_check.important')}:</strong> {t('forms.credit_check.soft_check_info')}
                </p>
              </div>
            </CardContent>
          </Card>
      ...
      <div className="max-w-2xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-8">
          <div className="bg-white rounded-lg p-4 border border-gray-200 text-center">
            ...
            <div className="text-sm font-medium text-gray-900">{t('forms.credit_check.no_impact')}</div>
          </div>
          
          <div className="bg-white rounded-lg p-4 border border-gray-200 text-center">
            <CreditCard className="w-6 h-6 text-blue-600 mx-auto mb-2" />
            <div className="text-sm font-medium text-gray-900">{t('forms.credit_check.personal_terms')}</div>
          </div>
