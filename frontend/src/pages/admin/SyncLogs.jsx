    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-gray-600">History of AutoSync executions</p>
        </div>
                ...
                <tbody className="divide-y">
                  {logs.map(log => (
                    <tr key={log.id} className="hover:bg-gray-50">
                      ...
                      <td className="px-4 py-3 text-sm">{log.model || 'All'}</td>
                      <td className="px-4 py-3 text-sm">
                        MF: {Object.keys(log.changes?.mf_changes || {}).length},
                        RV: {Object.keys(log.changes?.rv_changes || {}).length}
                      </td>
                      <td className="px-4 py-3">
